...
Environment.publicEnvironments = [
  new Environment({
    ...
    azureDataLakeStoreFileSystemEndpointSuffix: 'azuredatalake.net',
    azureDataLakeAnalyticsCatalogAndJobEndpointSuffix: 'azurebiganalytics.net'
  }),
  new Environment({
  ...
  new Environment({
    ...
    activeDirectoryGraphResourceId: 'https://graph.windows.net/',
    activeDirectoryGraphApiVersion: '2013-04-05',
    storageEndpointSuffix: '.core.usgovcloudapi.cn'
  })
];
