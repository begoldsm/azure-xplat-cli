...
exports.createDataLakeFileSystemManagementClient = function (subscription, options) {
	// TODO: This won't work as is due to the fact that the underlying client creation script
	// is not published as well. The functionality that was changed in service.js needs to be available.
	// TODO: Get it published once it is validated that it works.
	if(!options) {
	  options = {
	    endpoint: subscription.azureDataLakeFileSystemEndpointSuffix,
    ...
    if(!options.endpoint) {
        options.endpoint = subscription.azureDataLakeFileSystemEndpointSuffix;
    }
	...
	var factoryMethod = require('azure-arm-datalake').createDataLakeFileSystemManagementClient;
	return _createArmClient(factoryMethod, subscription, options);
	
}

exports.createDataLakeManagementClient = function (subscription) {
	var factoryMethod = require('azure-arm-datalake').createDataLakeManagementClient;
	return _createArmClient(factoryMethod, subscription);
}

exports.createBigAnalyticsManagementClient = function (subscription) {
	var factoryMethod = require('azure-arm-biganalytics').createBigAnalyticsManagementClient;
	return _createArmClient(factoryMethod, subscription);
}

exports.createBigAnalyticsJobManagementClient = function (subscription) {
	var options = {
		endpoint: subscription.azureBigAnalyticsCatalogAndJobEndpointSuffix
	};
	var factoryMethod = require('azure-arm-biganalytics').createBigAnalyticsJobManagementClient;
	return _createArmClient(factoryMethod, subscription, options);
}

exports.createBigAnalyticsCatalogManagementClient = function (subscription) {
	var options = {
		endpoint: subscription.azureBigAnalyticsCatalogAndJobEndpointSuffix
	};
	
	var factoryMethod = require('azure-arm-biganalytics').createBigAnalyticsCatalogManagementClient;
	return _createArmClient(factoryMethod, subscription, options);
}
