...
Environment.parameters = [
  ...
  new EnvironmentParameter('azureDataLakeFileSystemEndpointSuffix', 'AZURE_DATALAKE_FILESYSTEM_DNS_SUFFIX', 'the datalake filesystem service dns suffix'),
  new EnvironmentParameter('azureBigAnalyticsCatalogAndJobEndpointSuffix', 'AZURE_BIGANALYTICS_JOB_CATALOG_DNS_SUFFIX', 'the biganalytics job and catalog service dns suffix')
];
...
Environment.publicEnvironments = [
  new Environment({
    ...
    azureDataLakeFileSystemEndpointSuffix: 'azuredatalake.net',
    azureBigAnalyticsCatalogAndJobEndpointSuffix: 'azurebiganalytics.net'
  }),
  new Environment({
    ...
    // TODO: add dns suffixes for the china cloud for datalake and biganalytics once they are defined.
  })
];
