...
exports.createKonaManagementClient = function (subscription) {
	var factoryMethod = require('azure-arm-kona').createKonaManagementClient;
	return _createArmClient(factoryMethod, subscription);
}

exports.createKonaJobManagementClient = function (subscription) {
	var options = {
		endpoint: 'microsoftkonacompute.net'
	};
	var factoryMethod = require('azure-arm-kona').createKonaJobManagementClient;
	return _createArmClient(factoryMethod, subscription, options);
}

exports.createKonaCatalogManagementClient = function (subscription) {
	var options = {
		endpoint: 'microsoftkonacompute.net'
	};
	
	var factoryMethod = require('azure-arm-kona').createKonaCatalogManagementClient;
	return _createArmClient(factoryMethod, subscription, options);
}
