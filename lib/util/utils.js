...
exports.createStorageResourceProviderClient = function (subscription) {
  var factoryMethod = require('azure-arm-storage').createStorageManagementClient;
  return _createArmClient(factoryMethod, subscription);
};
...
exports.createDataLakeFileSystemManagementClient = function (subscription, options) {
  ...
  var factoryMethod = require('azure-arm-datalake-store').createDataLakeFileSystemManagementClient;
  return _createArmClient(factoryMethod, subscription, options);
  
};

exports.createDataLakeManagementClient = function (subscription) {
  var factoryMethod = require('azure-arm-datalake-store').createDataLakeManagementClient;
  return _createArmClient(factoryMethod, subscription);
};

exports.createDataLakeAnalyticsManagementClient = function (subscription) {
  var factoryMethod = require('azure-arm-datalake-analytics').createDataLakeAnalyticsManagementClient;
  return _createArmClient(factoryMethod, subscription);
};

exports.createDataLakeAnalyticsJobManagementClient = function (subscription) {
  var options = {
    endpoint: subscription.azureDataLakeAnalyticsCatalogAndJobEndpointSuffix
  };
  var factoryMethod = require('azure-arm-datalake-analytics').createDataLakeAnalyticsJobManagementClient;
  return _createArmClient(factoryMethod, subscription, options);
};
...
exports.createDataLakeAnalyticsCatalogManagementClient = function (subscription) {
  ...
  var factoryMethod = require('azure-arm-datalake-analytics').createDataLakeAnalyticsCatalogManagementClient;
  return _createArmClient(factoryMethod, subscription, options);
};
