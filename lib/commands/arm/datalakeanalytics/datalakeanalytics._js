...
exports.init = function (cli) {
  ...
  var dataLakeAnalyticsCommands = cli.category('datalakeanalytics')
    .description($('Commands to manage your DataLake Analytics objects'));
  var dataLakeAnalyticsJob = dataLakeAnalyticsCommands.category('job')
    .description($('Commands to manage your DataLake Analytics Jobs'));
  ...
  var dataLakeAnalyticsCatalog = dataLakeAnalyticsCommands.category('catalog')
    .description($('Commands to manage your DataLake Analytics Catalog'));
  ...
  var dataLakeAnalyticsAccount = dataLakeAnalyticsCommands.category('account')
    .description($('Commands to manage your DataLake Analytics accounts'));
  ...
  dataLakeAnalyticsAccount.command('show [dataLakeAnalyticsAccountName] [resourceGroup]')
    ...
    .description($('Creates a DataLakeAnalytics Account'))
	...
	dataLakeAnalyticsAccount.command('set [dataLakeAnalyticsAccountName] [resourceGroup] [defaultDataLake] [tags]')
    .description($('Creates a DataLakeAnalytics Account'))
	...
	.option('-t --tags <tags>', $('the optional key, value paired set of tags to associate with this account resource.'))
    .execute(function (dataLakeAnalyticsAccountName, resourceGroup, defaultDataLake, tags, options, _) {
      var subscription = profile.current.getSubscription(options.subscription);
	  var client = utils.createDataLakeAnalyticsManagementClient(subscription);
	  ...
	  if (!defaultDataLake) {
		  defaultDataLake = dataLakeAnalyticsAccount.properties.configuration.defaultStorage;
	  }
	  if(!tags) {
		  tags = dataLakeAnalyticsAccount.tags;
	  }
	  
      dataLakeAnalyticsAccount  = createOrUpdateDataLakeAnalyticsAccount(subscription, dataLakeAnalyticsAccountName, resourceGroup, dataLakeAnalyticsAccount.location, defaultDataLake, tags, _);
      dataLakeAnalyticsUtils.formatOutput(cli, log, options, dataLakeAnalyticsAccount);    
    });
	
	dataLakeAnalyticsAccount.command('adddatasource [dataLakeAnalyticsAccountName] [dataLake] [isDefaultDataLake] [azureBlob] [accessKey] [resourceGroup]')
    .description($('Adds an existing data source (Data Lake or Azure Blob) to the dataLakeAnalytics account'))
    .usage('[options] <dataLakeAnalyticsAccountName> <dataLake> <isDefaultDataLake> <azureBlob> <accessKey> <resourceGroup>')
    .option('-n --dataLakeAnalyticsAccountName <dataLakeAnalyticsAccountName>', $('The DataLakeAnalytics account name to perform the action on.'))
    ...
    .execute(function (dataLakeAnalyticsAccountName, resourceGroup, defaultDataLake, tags, options, _) {
	  ...
	  client.dataLakeAnalyticsAccount.addDataSource(resourceGroup, dataLakeAnalyticsAccountName, parameters);
	  ...
	  if(isDefaultDataLake) {
		...
		client.dataLakeAnalyticsAccount.setDefaultDataSource(resourceGroup, dataLakeAnalyticsAccountName, defaultParams);
	  }
	  
	  log.info($('Successfully added the storage account specified to DataLakeAnalytics account: ' + dataLakeAnalyticsAccountName));
    });
	
	dataLakeAnalyticsAccount.command('removedatasource [dataLakeAnalyticsAccountName] [dataLake] [azureBlob] [resourceGroup]')
    .description($('removes a data source (Data Lake or Azure Blob) from the dataLakeAnalytics account'))
    .usage('[options] <dataLakeAnalyticsAccountName> <dataLake> <azureBlob> <resourceGroup>')
    .option('-n --dataLakeAnalyticsAccountName <dataLakeAnalyticsAccountName>', $('The DataLakeAnalytics account name to perform the action on.'))
    ...
    .execute(function (dataLakeAnalyticsAccountName, resourceGroup, defaultDataLake, tags, options, _) {
	  ...
	  client.dataLakeAnalyticsAccount.removeDataSource(resourceGroup, dataLakeAnalyticsAccountName, parameters);
	  log.info($('Successfully removed the storage account specified from DataLakeAnalytics account: ' + dataLakeAnalyticsAccountName));
    });
	
	dataLakeAnalyticsAccount.command('setdatasource [dataLakeAnalyticsAccountName] [dataLake] [isDefaultDataLake] [azureBlob] [accessKey] [resourceGroup]')
    .description($('Sets an existing data source (Data Lake or Azure Blob) in the dataLakeAnalytics account. Typically used to set the data source as default (for Data Lake) or update the access key (for Azure Blob)'))
    .usage('[options] <dataLakeAnalyticsAccountName> <dataLake> <isDefaultDataLake> <azureBlob> <accessKey> <resourceGroup>')
    .option('-n --dataLakeAnalyticsAccountName <dataLakeAnalyticsAccountName>', $('The DataLakeAnalytics account name to perform the action on.'))
    ...
    .execute(function (dataLakeAnalyticsAccountName, resourceGroup, defaultDataLake, tags, options, _) {
	  ...
	  client.dataLakeAnalyticsAccount.setDataSource(resourceGroup, dataLakeAnalyticsAccountName, parameters);
  ...
  function createOrUpdateDataLakeAnalyticsAccount(subscription, dataLakeAnalyticsAccountName, resourceGroup, location, defaultDataLake, tags, _) {
	  if (!dataLakeAnalyticsAccountName) {
        return cli.missingArgument('dataLakeAnalyticsAccountName');
      }
	  if (!location) {
	  ...
	  var create = false;
	  try {
		var dataLakeAnalyticsAccount = client.dataLakeAnalyticsAccount.get(resourceGroup, dataLakeAnalyticsAccountName, _);
	  }
	  catch(err){
		create = true;
	  }
	  ...
	  if(create) {
		  var response = client.dataLakeAnalyticsAccount.create(resourceGroup, accountParams, _);
	  }
	  else {
		  var response = client.dataLakeAnalyticsAccount.update(resourceGroup, accountParams, _);
	  }
	  ...
	  switch (catalogItemType.toLowerCase()) {
		  case "database":
		    if(isList) {
				...
				toReturn.push(client.catalog.getDatabase(resourceGroup, dataLakeAnalyticsAccountName, catologItem.databaseName, _).database);
			}
			break;
		  case "schema":
		    if(isList) {
				...
				toReturn.push(client.catalog.getDatabase(resourceGroup, dataLakeAnalyticsAccountName, catologItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, _).schema);
			}
			break;
		  case "assembly":
		    if(isList) {
				...
				toReturn.push(client.catalog.getDatabase(resourceGroup, dataLakeAnalyticsAccountName, catologItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, _).assembly);
			}
			break;
		  case "externaldatasource":
		    if(isList) {
				...
				toReturn.push(client.catalog.getDatabase(resourceGroup, dataLakeAnalyticsAccountName, catologItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, _).externalDataSource);
			}
			break;
		  case "table":
		    if(isList) {
				...
				toReturn.push(client.catalog.getDatabase(resourceGroup, dataLakeAnalyticsAccountName, catologItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, catalogItem.tableOrTableValuedFunctionName, _).table);
			}
			break;
		  case "tablevaluedfunction":
		    if(isList) {
				...
				toReturn.push(client.catalog.getDatabase(resourceGroup, dataLakeAnalyticsAccountName, catologItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, catalogItem.tableOrTableValuedFunctionName, _).tableValuedFunction);
			}
			break;
		  case "tablestatistics":
		    if(isList) {
				...
				toReturn.push(client.catalog.getDatabase(resourceGroup, dataLakeAnalyticsAccountName, catologItem.databaseName, catalogItem.schemaAssemblyOrExternalDataSourceName, catalogItem.tableOrTableValuedFunctionName, catalogItem.tableStatisticsName, _).statistics);
			}
			break;
		  default:
